...
public class Usuarios {
    ...
    private Usuario_Ob userSelected;
    ...
    public Usuarios(Home home, UtilPanels panel) {
        ...
        menuTabla = new MenuEditarYEstado(home.tableUsuarios, true,
    ...
    private Usuario_Ob userSelected(long id) {
        try {
            //Conexion a la api
            ...
            if (response.isSuccessful()) {
                String json = response.body().string();
                Usuario_Ob usuario = gson.fromJson(json, Usuario_Ob.class);
                return usuario;
            } else {
